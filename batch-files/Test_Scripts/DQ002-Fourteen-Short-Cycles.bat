...
REM --------------------------------------------------------------
REM setup config files for one short cycle test.
@echo on
...
@echo copying  test files over the original ini files for fourteen short cycles.
copy C:\_SJM\OPS-PD\test_apps\production\release\Ampere_Run_in\Test_Scripts\Ini_Files\run-in-config-fourteen-short-cycles.ini C:\_SJM\OPS-PD\test_apps\production\release\Ampere_Run_in\run-in-config.ini > NUL
