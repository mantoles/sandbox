@echo off
REM --------------------------------------------------------------
REM Known Error remove to cause a fail
...
attrib -r C:\_SJM\OPS-PD\test_apps\production\release\Ampere_Run_in\known_error.ini 
copy C:\_SJM\OPS-PD\test_apps\production\release\Ampere_Run_in\Test_Scripts\Ini_Files\known-error-modified.ini C:\_SJM\OPS-PD\test_apps\production\release\Ampere_Run_in\known_error.ini > NUL
