...
@echo copying  test files over the original ini files...
copy C:\_SJM\OPS-PD\test_apps\production\release\Ampere_Run_in\Test_Scripts\Ini_Files\run-in-config-time-fail-high.ini C:\_SJM\OPS-PD\test_apps\production\release\Ampere_Run_in\run-in-config.ini > NUL
