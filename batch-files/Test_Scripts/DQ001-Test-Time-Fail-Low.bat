...
@echo copying  test files over the original ini files to create a fail test time condition..
copy C:\_SJM\OPS-PD\test_apps\production\release\Ampere_Run_in\Test_Scripts\Ini_Files\run-in-config-time-fail-low.ini C:\_SJM\OPS-PD\test_apps\production\release\Ampere_Run_in\run-in-config.ini > NUL
