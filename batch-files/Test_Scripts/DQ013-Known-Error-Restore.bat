...
copy C:\_SJM\OPS-PD\test_apps\production\release\Ampere_Run_in\Test_Scripts\Ini_Files\known_error.ini C:\_SJM\OPS-PD\test_apps\production\release\Ampere_Run_in\known_error.ini > NUL
attrib +r C:\_SJM\OPS-PD\test_apps\production\release\Ampere_Run_in\known_error.ini >NUL
